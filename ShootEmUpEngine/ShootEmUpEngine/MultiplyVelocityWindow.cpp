...
MultiplyVelocityWindow::MultiplyVelocityWindow(int xLoc, int yLoc, int mainWindowWidth, int mainWindowHeight, EXEventComponent* myEvent, EXActionComponent* myAction, TTF_Font* inputFont)
{
	...
	gameWindow = SDL_CreateWindow("Multiply Velocity Window", xLoc + (mainWindowWidth / 2) - (windowWidth / 2), yLoc + (mainWindowHeight / 2) - (windowHeight / 2), windowWidth, windowHeight, SDL_WINDOW_BORDERLESS);
...
bool MultiplyVelocityWindow::Update()
{
	int mouseX, mouseY;
...
void MultiplyVelocityWindow::Draw()
{
...
int MultiplyVelocityWindow::CheckSelected()
{
	return selectedVal;
}
